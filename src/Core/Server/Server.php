...
abstract class Server extends BaseNode
{
    ...
    /**
     * @var array Generic, protocol-agnostic session properties keyed by fd.
     *             Stores per-connection state such as client_id and protocol
     *             level. Reverse-mapped by $connectionSessions.
     */
    public static $fdSessions = [];

    /**
     * Store a value under a key for the given connection fd.
     *
     * @param int $fd Connection file descriptor.
     * @param string $key Property name.
     * @param mixed $value Property value.
     */
    public static function setFdSession(int $fd, string $key, mixed $value): void
    {
        self::$fdSessions[$fd][$key] = $value;
    }

    /**
     * Retrieve a value stored under a key for the given connection fd.
     *
     * @param int $fd Connection file descriptor.
     * @param string $key Property name.
     * @return mixed The stored value, or null if the key/fd is unknown.
     */
    public static function getFdSession(int $fd, string $key): mixed
    {
        return self::$fdSessions[$fd][$key] ?? null;
    }
     ...
     *             owning fd and other session data.
     */
    public static $connectionSessions = [];
    
    /**
     * Store a value under a key for the given client_id (logical connection).
     *
     * @param string $clientId Logical connection identifier (MQTT client_id).
     * @param string $key Property name.
     * @param mixed $value Property value.
     */
    public static function setClientSession(string $clientId, string $key, mixed $value): void
    {
        self::$connectionSessions[$clientId][$key] = $value;
    }

    /**
     * Retrieve a value stored under a key for the given client_id.
     *
     * @param string $clientId Logical connection identifier (MQTT client_id).
     * @param string $key Property name.
     * @return mixed The stored value, or null if the key/client_id is unknown.
     */
