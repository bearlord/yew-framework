...
namespace Yew\Plugins\Mqtt\Topic\Storage\Db;
 ...
 *
 * Local copy of Yew\Plugins\Topic\Storage\Db\DbDriver so the Mqtt plugin
...
class DbDriver implements DriverInterface
{
     ...
     */
    protected string $tableName = "mqtt_topic_subscription";
    ...
    protected function createTable()
    {
        ...
        $this->getDb()->createCommand()->createTable("{{%$tableName}}", [
            "id" => Schema::TYPE_PK,
            "client_id" => Schema::TYPE_STRING . "(240) NOT NULL",
    ...
    /**
     * Remove a subscription for a clientId from a topic
     *
    ...
    /**
     * Retrieve all distinct subscriber client_ids across all topics
     *
     * @return array|null List of distinct subscriber client_ids, or null if none exist
     */
     ...
     * @return array|null List of subscriber client_ids subscribed to the topic, or null if none found
     */
     ...
     *
     * @param string $clientId The client_id of the subscriber
     * @return array|null List of topic patterns the client_id is subscribed to, or null if none found
     */
