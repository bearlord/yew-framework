...
namespace Yew\Plugins\Amqp\Builder;

use Yew\Plugins\Amqp\AmqpConnection;
...
/**
 * Class Builder
 * @package Yew\Plugins\Amqp\Builder
 */
class Builder
{
    use GetAmqp;
     ...
     * @var string
     */
    public $exchangeName = "yew-exchange";
     ...
     * @var string
     */
    public $routingKey = "yew-routing-key";
