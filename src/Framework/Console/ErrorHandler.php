 ...
 * @since 2.0
 */
class ErrorHandler extends \Yew\Framework\Base\ErrorHandler
{
    /**
    ...
    protected function renderException($exception)
    {
        ...
        if ($exception instanceof UnknownCommandException) {
        ...
        } elseif ($exception instanceof UserException && ($exception instanceof Exception || !$debug)) {
            ...
            if ($exception instanceof \Yew\Framework\Db\Exception && !empty($exception->errorInfo)) {
    ...
    protected function formatMessage($message, $format = [Console::FG_RED, Console::BOLD])
    {
        ...
        if (
            Yew::$app->controller instanceof \Yew\Framework\Console\Controller && Yew::$app->controller->isColorEnabled($stream)
            || Yew::$app instanceof \Yew\Framework\Console\Application && Console::streamSupportsAnsiColors($stream)
        ) {
