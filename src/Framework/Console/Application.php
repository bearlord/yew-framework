 ...
 * @property \Yew\Yii\Web\User $user The user component. This property is read-only.
 * @property \Yew\Yii\Caching\Cache $cache The cache application component. Null if the component is not enabled.
 * @property \Yew\Yii\Base\Security $security The security application component. This property is read-only.
 */
class Application extends \Yew\Yii\Base\Application
{
    /**
     ...
     */
    public static function instance(?bool $refresh = false): \Yew\Yii\Base\Application
    {
    ...
    public function createControllerByID($id)
    {
        ...
        if (is_subclass_of($className, 'Yew\Framework\Console\Controller')) {
            ...
            throw new InvalidConfigException("Controller class must extend from \\Yew\Yii\\Console\\Controller.");
        } else {
            return null;
        }
    }
     ...
     * @throws \Yew\Yii\Base\InvalidConfigException
