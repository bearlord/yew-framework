...
class AssetBundle extends BaseObject
{
    ...
    public function init()
    {
        if ($this->sourcePath !== null) {
            $this->sourcePath = rtrim(Yew::getAlias($this->sourcePath), '/\\');
        }
        if ($this->basePath !== null) {
            $this->basePath = rtrim(Yew::getAlias($this->basePath), '/\\');
        }
     ...
     * @param \Yew\Framework\Web\View $view the view that the asset files are to be registered with.
     */
