...
class MessageFormatter extends Component
{
     ...
     * @throws \Yew\FrameworkBase\NotSupportedException when PHP intl extension is not installed.
     */
     ...
     * @throws \Yew\FrameworkBase\NotSupportedException when unsupported formatting is used.
     */
