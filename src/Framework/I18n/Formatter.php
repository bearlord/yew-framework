...
use Yew\Framework\Helpers\HtmlPurifier;
 ...
 *
 * Formatter is configured as an application component in [[\Yew\FrameworkBase\Application]] by default.
 * You can access that instance via `Yew::$app->formatter`.
 *
...
class Formatter extends Component
{
    ...
    /**
     * @var array|null the text to be displayed when formatting a boolean value. The first element corresponds
     ...
     * If this property is not set, [[\Yew\FrameworkBase\Application::timeZone]] will be used.
     *
    ...
    /**
     * @var \ResourceBundle|null cached ResourceBundle object used to read unit translations
     */
     ...
     * @return string the formatted result.
     */
    public function asText(?string $value = null): string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @return string the formatted result.
     */
    public function asNtext(?string $value = null): string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @return string the formatted result.
     */
    public function asParagraphs(?string $value = null): string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @return string the formatted result.
     */
    public function asHtml(?string $value = null, ?array $config = null): ?string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @param string|null $value the value to be formatted.
     * @param array|null $options the tag options in terms of name-value pairs. See [[Html::mailto()]].
     * @return string the formatted result.
     */
    public function asEmail(?string $value = null, ?array $options = []): string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @param mixed $value the value to be formatted.
     * @param array|null $options the tag options in terms of name-value pairs. See [[Html::img()]].
     * @return string the formatted result.
     */
     ...
     * @param mixed $value the value to be formatted.
     * @param array|null $options the tag options in terms of name-value pairs. See [[Html::a()]].
     * @return string the formatted result.
     */
     ...
     * @return string the formatted result.
     * @throws InvalidArgumentException|\Exception if the input value can not be evaluated as a date value.
     */
     ...
     *
     * @param mixed $value the value to be formatted.
     * @param array|null $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array|null $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     * @return string the formatted result.
     ...
     * @see asShortSize
     */
    public function asSize($value, int $decimals = null, ?array $options = [], ?array $textOptions = []): string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @return string the formatted result.
     * @throws InvalidArgumentException if the input value is not numeric or the formatting failed.
     * @throws InvalidConfigException|\IntlException when INTL is not installed or does not contain required information.
     * @see asLength
     * @since 2.0.13
     ...
     * @author John Was <janek.jan@gmail.com>
     */
    public function asShortWeight($value, ?int $decimals = null, ?array $options = [], ?array $textOptions = []): string
    {
     ...
     * @param float|null $baseUnit unit of value as the multiplier of the smallest unit. When `null`, property [[baseUnits]]
     * will be used to determine base unit using $unitType and $unitSystem.
     * @param string|null $unitSystem either [[UNIT_SYSTEM_METRIC]] or [[UNIT_SYSTEM_IMPERIAL]]. When `null`, property [[systemOfUnits]] will be used.
     * @param int|null $decimals the number of digits after the decimal point.
     * @param array|null $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array|null $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     * @return string
     * @throws InvalidConfigException|\IntlException when INTL is not installed or does not contain required information
     */
    private function formatUnit(string $unitType, string $unitFormat, $value, ?float $baseUnit = null, ?string $unitSystem = null, ?int $decimals = null, ?array $options = null, ?array $textOptions = null): string
    {
        if ($value === null) {
            return $this->nullDisplay;
        }
     ...
     * @param array $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     * @return array [parameters for Yew::t containing formatted number, internal position of size unit]
     * @throws InvalidArgumentException if the input value is not numeric or the formatting failed.
     */
    private function formatNumber($value, ?int $decimals = null, ?int $maxPosition = null, $formatBase, ?array $options = [], ?array $textOptions = []): array
    {
        $value = $this->normalizeNumericValue($value);
