...
class PhpMessageSource extends MessageSource
{
     ...
     * @see sourceLanguage
     */
    protected function loadMessages(string $category, string $language)
    {
        ...
        if ($language !== $fallbackLanguage) {
            ...
            if ($messages === null) {
                Yew::warning("The message file for category '$category' does not exist: $messageFile", __METHOD__);
            }
        }
    ...
    protected function loadFallbackMessages($category, $fallbackLanguage, $messages, $originalMessageFile)
    {
        ...
        if (
            ...
            Yew::error("The message file for category '$category' does not exist: $originalMessageFile "
    ...
    {
        $messageFile = Yew::getAlias($this->basePath) . "/$language/";
