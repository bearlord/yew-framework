...
class MessageSource extends Component
{
     ...
     * [[\Yew\FrameworkBase\Application::sourceLanguage]].
     */
    ...
    public function init()
    {
        ...
        if ($this->sourceLanguage === null) {
            $this->sourceLanguage = Yew::$app->sourceLanguage;
        }
    }
     ...
     */
    protected function translateMessage(string $category, string $message, string $language)
    {
