...
class GettextMessageSource extends MessageSource
{
    ...
    protected function loadMessages(string $category, string $language): array
    {
        ...
        if ($fallbackLanguage !== $language) {
            ...
            if ($messages === null) {
                Yew::error("The message file for category '$category' does not exist: $messageFile", __METHOD__);
            }
        }
    ...
    {
        $messageFile = Yew::getAlias($this->basePath) . '/' . $language . '/' . $this->catalog;
        if ($this->useMoFile) {
