...
class DbMessageSource extends MessageSource
{
     ...
     * @throws InvalidConfigException|\ReflectionException if [[db]] is invalid or [[cache]] is invalid.
     */
    public function init()
    {
        ...
        if ($this->enableCaching) {
            $this->cache = Instance::ensure($this->cache, 'Yew\FrameworkCaching\CacheInterface');
        }
    }
     ...
     * @since 2.0.7
     */
    protected function createFallbackQuery(string $category, string $language, string $fallbackLanguage)
    {
