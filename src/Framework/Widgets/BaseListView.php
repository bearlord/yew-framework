...
abstract class BaseListView extends Widget
{
    ...
    public $options = [];
    /**
     * @var \Yew\Framework\Data\DataProviderInterface the data provider for the view. This property is required.
     */
    public $dataProvider;
    /**
     ...
     * [[\Yew\Framework\Data\BaseDataProvider::pagination|pagination]] value of the [[dataProvider]] and will overwrite this value.
     */
    public $pager = [];
    /**
     ...
     * [[\Yew\Framework\Data\BaseDataProvider::sort|sort]] value of the [[dataProvider]] and will overwrite this value.
     */
    public $sorter = [];
    /**
    ...
    public function init()
    {
        ...
        if ($this->emptyText === null) {
            $this->emptyText = Yew::t('yew', 'No results found.');
        }
    ...
    public function renderSummary()
    {
        ...
        if (($pagination = $this->dataProvider->getPagination()) !== false) {
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, Yew::t('yew', 'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.', [
                        'begin' => $begin,
                        'end' => $end,
                        'count' => $count,
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, Yew::t('yew', 'Total <b>{count, number}</b> {count, plural, one{item} other{items}}.', [
                    'begin' => $begin,
                    'end' => $end,
                    'count' => $count,
                    'totalCount' => $totalCount,
        ...
        return Yew::$app->getI18n()->format($summaryContent, [
            'begin' => $begin,
            'end' => $end,
            'count' => $count,
            'totalCount' => $totalCount,
