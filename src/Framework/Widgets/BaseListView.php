...
abstract class BaseListView extends Widget
{
    ...
    public function init()
    {
        ...
        if ($this->emptyText === null) {
            $this->emptyText = Yew::t('yii', 'No results found.');
        }
    ...
    public function renderSummary()
    {
        ...
        if (($pagination = $this->dataProvider->getPagination()) !== false) {
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, Yew::t('yii', 'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.', [
                        'begin' => $begin,
                        'end' => $end,
                        'count' => $count,
            ...
            if (($summaryContent = $this->summary) === null) {
                return Html::tag($tag, Yew::t('yii', 'Total <b>{count, number}</b> {count, plural, one{item} other{items}}.', [
                    'begin' => $begin,
                    'end' => $end,
                    'count' => $count,
                    'totalCount' => $totalCount,
