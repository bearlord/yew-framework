 ...
 *
 * Classes extending from this widget can be used in an [[\Yew\Framework\Widgets\ActiveForm|ActiveForm]]
 * using the [[\Yew\Framework\Widgets\ActiveField::widget()|widget()]] method, for example like this:
 *
 * ```php
...
{
    /**
     * @var \Yew\Framework\Widgets\ActiveField active input field, which triggers this widget rendering.
     * This field will be automatically filled up in case widget instance is created via [[\Yew\Framework\Widgets\ActiveField::widget()]].
     * @since 2.0.11
     */
    public $field;
    /**
