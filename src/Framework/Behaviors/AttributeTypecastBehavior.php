...
namespace Yew\Framework\Behaviors;
...
use Yew\Framework\Validators\BooleanValidator;
use Yew\Framework\Validators\NumberValidator;
use Yew\Framework\Validators\StringValidator;
 ...
 * It may also come in handy for regular [[\Yew\Framework\Db\ActiveRecord]] or even [[\Yew\Framework\Base\Model]], allowing to maintain
 * strict attribute types after model validation.
 *
 * This behavior should be attached to [[\Yew\Framework\Base\Model]] or [[\Yew\Framework\Db\BaseActiveRecord]] descendant.
 *
 ...
 *
 * class Item extends \Yew\Framework\Db\ActiveRecord
 * {
...
class AttributeTypecastBehavior extends Behavior
{
     ...
     * For example, in case of [[\Yew\Framework\Db\ActiveRecord]] usage, typecasting before save
     ...
     * This option may be disabled in order to achieve better performance.
     * For example, in case of [[\Yew\Framework\Db\ActiveRecord]] usage, typecasting after find
     ...
     * @param \Yew\Framework\Base\Event $event event instance.
     */
