...
use Yew\Framework\Validators\UniqueValidator;
 ...
 *
 * ```php
 * use Yew\Framework\Behaviors\SluggableBehavior;
 *
 ...
 * not be validated, i.e. the `slug` attribute should not appear in the [[\Yew\Framework\Base\Model::rules()|rules()]] method of the model.
 *
...
class SluggableBehavior extends AttributeBehavior
{
     ...
     * The default implementation calls [[\Yew\Framework\Helpers\Inflector::slug()]] on the input strings
