 ...
 *
 * ```php
 * use Yew\Framework\Behaviors\AttributeBehavior;
 *
 ...
 * not be validated, i.e. they should not appear in the [[\Yew\Framework\Base\Model::rules()|rules()]] method of the model.
 *
...
class AttributeBehavior extends Behavior
{
     ...
     * callable in array format (e.g. `[$this, 'methodName']`), an [[\Yew\Framework\Db\Expression|Expression]] object representing a DB expression
