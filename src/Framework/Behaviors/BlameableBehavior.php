 ...
 *
 * ```php
 * use Yew\Framework\Behaviors\BlameableBehavior;
 *
 ...
 * not be validated, i.e. `created_by` and `updated_by` should not appear in the [[\Yew\Framework\Base\Model::rules()|rules()]] method of the model.
 *
