...
use Yew\Framework\Db\QueryTrait;
...
class ActiveQuery extends Component implements ActiveQueryInterface
{
     ...
     * @param ConnectionInterface|Connection|null $db the database connection used to execute the query.
     ...
     * @throws \Throwable
     */
    public function count($q = '*', ?ConnectionInterface $db = null): int
    {
        if ($this->emulateExecution) {
            return 0;
        }
     ...
     * @throws \Throwable
     */
    public function column(string $column, ?ConnectionInterface $db = null)
    {
        if ($this->emulateExecution) {
            return [];
        }
     ...
     * @throws \Throwable
     */
    public function sum(string $column, ?ConnectionInterface $db = null)
    {
        if ($this->emulateExecution) {
            return 0;
        }
     ...
     * @throws \Throwable
     */
    public function average(string $column, Connection $db = null)
    {
        if ($this->emulateExecution) {
            return 0;
        }
     ...
     * @throws \Throwable
     */
    public function min(string $column, $db = null)
    {
        if ($this->emulateExecution) {
            return null;
        }
     ...
     * @throws \Throwable
     */
    public function max(string $column, ?ConnectionInterface $db = null)
    {
        if ($this->emulateExecution) {
            return null;
        }
     ...
     * @throws \Throwable
     */
    protected function executeScript(?ConnectionInterface $db, string $type, $columnName = null)
    {
     ...
     * @throws NotSupportedException
     */
    private function findByPk(?ConnectionInterface $db, string $type, $columnName = null)
    {
