...
namespace Yew\Framework\Generator\Model;
 ...
 * @since 2.0
 */
class Generator extends \Yew\Framework\Generator\Generator
{
    ...
    public $tableName;
    public $modelClass;
    public $baseClass = 'Yew\Framework\Db\ActiveRecord';
    ...
    public function generate(): array
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            if ($queryClassName) {
                ...
                $files[] = new CodeFile(
                    Yew::getAlias('@' . str_replace('\\', '/', $this->queryNs)) . '/' . $queryClassName . '.php',
     ...
     * @param \Yew\Framework\Db\TableSchema $table the table schema
     ...
     * @param \Yew\Framework\Db\TableSchema the table being checked
     ...
     *
     * @param \Yew\Framework\Db\TableSchema $table
     * @param array $fks
     * @return bool
     * @since 2.0.5
     */
     ...
     */
    protected function generateRelationLink(array $refs)
    {
        $pairs = [];
        foreach ($refs as $a => $b) {
            $pairs[] = "'$a' => '$b'";
     ...
     */
    protected function generateClassName(string $tableName, ?bool $useSchemaName = null): string
    {
     ...
     */
    protected function generateQueryClassName(string $modelClassName)
    {
    ...
    protected function getDbDriverName(): ?string
    {
        /** @var Connection $db */
        $db = $this->getDbConnection();
        return $db instanceof \Yew\Framework\Db\Connection ? $db->driverName : null;
    }
