 ...
 *
 * @property \Yew\Framework\Validators\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\Yew\Framework\Validators\Validator[] $validators All the validators declared in the model.
...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * The form name is mainly used by [[\Yew\Framework\Widgets\ActiveForm]] to determine how to name
     ...
     *
     * @param null $attributeNames attribute name or list of attribute names that should be validated.
     ...
     * ```
     *
     * @return ArrayObject|\Yew\Framework\Validators\Validator[] all the validators declared in the model.
     * @throws \Yew\Framework\Exception\InvalidConfigException
     */
     ...
     * @param null $attribute the name of the attribute whose applicable validators should be returned.
     * If this is null, the validators for ALL attributes in the model will be returned.
     * @return \Yew\Framework\Validators\Validator[] the validators applicable to the current [[scenario]].
     * @throws \Yew\Framework\Exception\InvalidConfigException
     */
     ...
     * [[\Yew\Framework\Validators\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     *
     * Note that when the validator has a conditional validation applied using
     * [[\Yew\Framework\Validators\RequiredValidator::$when|$when]] this method will return
     ...
     * @param string $attribute attribute name
     * @param string|null $error new error message
     */
     ...
     * @param array|null $except list of attributes whose value should NOT be returned.
