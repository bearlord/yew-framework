 ...
 * its parent class [[\Yew\Framework\Base\BaseObject|BaseObject]].
 *
 ...
 * ```
 *
 * where `as tree` stands for attaching a behavior named `tree`, and the array will be passed to [[\Yew::createObject()]]
...
class Component extends BaseObject
{
     ...
     * @throws \Yew\Framework\Exception\UnknownPropertyException if the property is not defined
     * @see __get()
     */
    public function __set(string $name, $value)
    {
        ...
        if (method_exists($this, $setter)) {
            ...
            $this->attachBehavior($name, $value instanceof Behavior ? $value : Yew::createObject($value));
     ...
     *     Yew::trace($event->name . ' is triggered.');
     * });
     * ```
     *
     * @param string $name the event name
    ...
    private function attachBehaviorInternal($name, $behavior)
    {
        if (!($behavior instanceof Behavior)) {
            $behavior = Yew::createObject($behavior);
        }
        if (is_int($name)) {
