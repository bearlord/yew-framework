...
class Logger extends Component
{
     ...
     * of [[\Yew\Framework\BaseYii]] class file.
     ...
     * For example, 'Yew\Framework\Db\*' will match categories starting with 'Yew\Framework\Db\',
     * such as 'Yew\Framework\Db\Connection'.
    ...
    {
        $timings = $this->getProfiling(['Yew\Framework\Db\Command::query', 'Yew\Framework\Db\Command::execute']);
        $count = count($timings);
        $time = 0;
