...
class Connection extends Component
{
    ...
    public $schemaMap = [
        ...
        'taos' => 'Yew\Framework\Db\Taos\Schema', // Taos
        'taosw' => 'Yew\Framework\Db\Taos\Schema', // Taos
    ];
    /**
     * @var string Custom PDO wrapper class. If not set, it will use [[PDO]] or [[\Yew\Framework\Db\mssql\PDO]] when MSSQL is used.
     * @see pdo
     */
    public $pdoClass;
    /**
     ...
     */
    public $commandClass = 'Yew\Framework\Db\Command';
    /**
     ...
     * Use 0 to indicate that the cached data will never expire.
     * @param \Yew\Framework\Caching\Dependency $dependency the cache dependency associated with the cached query results.
     ...
     * @param \Yew\Framework\Caching\Dependency $dependency the preferred caching dependency. If null, it will be ignored.
     ...
     */
    public function getTableSchema(string $name, bool $refresh = false)
    {
