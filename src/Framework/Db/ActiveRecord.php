 ...
 *
 * To declare an ActiveRecord class you need to extend [[\Yew\Framework\Db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \Yew\Framework\Db\ActiveRecord
 * {
...
class ActiveRecord extends BaseActiveRecord
{
    ...
    public function insert(?bool $runValidation = true, ?array $attributes = null): bool
    {
        if ($runValidation && !$this->validate($attributes)) {
            Yew::info('Model not inserted due to validation error.', __METHOD__);
            return false;
        }
    ...
    public function update(?bool $runValidation = true, array $attributeNames = null)
    {
        if ($runValidation && !$this->validate($attributeNames)) {
            Yew::info('Model not updated due to validation error.', __METHOD__);
            return false;
        }
