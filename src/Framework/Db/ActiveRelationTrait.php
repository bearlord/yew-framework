...
trait ActiveRelationTrait
{
     ...
     * @param callable|null $callable $callable a PHP callback for customizing the relation associated with the junction table.
     ...
     * @return $this the relation object itself.
     */
    public function inverseOf(string $relationName)
    {
     ...
     * @throws InvalidConfigException
     */
    private function populateInverseRelation(array &$primaryModels, array $models, string $primaryName, string $name)
    {
     ...
     * @return array
     */
    private function buildBuckets(array $models, array $link, array $viaModels = null, $viaQuery = null, bool $checkMultiple = true): array
    {
        if ($viaModels !== null) {
            $map = [];
