 ...
 * ['LIKE' => Yew\Framework\Db\condition\LikeCondition::class] ``` . This property is write-only.
...
class QueryBuilder extends BaseObject
{
     ...
     * ```php
     * return [
     *     'LIKE' => Yew\Framework\Db\condition\LikeCondition::class,
     * ];
     * ```
     *
     ...
     * ```php
     * [
     *    Yew\Framework\Db\Expression::class => Yew\Framework\Db\ExpressionBuilder::class
     * ]
     * ```
    ...
    {
        return [
            'NOT' => 'Yew\Framework\Db\Conditions\NotCondition',
            'AND' => 'Yew\Framework\Db\Conditions\AndCondition',
            'OR' => 'Yew\Framework\Db\Conditions\OrCondition',
            'BETWEEN' => 'Yew\Framework\Db\Conditions\BetweenCondition',
            'NOT BETWEEN' => 'Yew\Framework\Db\Conditions\BetweenCondition',
            'IN' => 'Yew\Framework\Db\Conditions\InCondition',
            'NOT IN' => 'Yew\Framework\Db\Conditions\InCondition',
            'LIKE' => 'Yew\Framework\Db\Conditions\LikeCondition',
            'NOT LIKE' => 'Yew\Framework\Db\Conditions\LikeCondition',
            'OR LIKE' => 'Yew\Framework\Db\Conditions\LikeCondition',
            'OR NOT LIKE' => 'Yew\Framework\Db\Conditions\LikeCondition',
            'EXISTS' => 'Yew\Framework\Db\Conditions\ExistsCondition',
            'NOT EXISTS' => 'Yew\Framework\Db\Conditions\ExistsCondition',
        ];
    }
    ...
    {
        return [
            'Yew\Framework\Db\Query' => 'Yew\Framework\Db\QueryExpressionBuilder',
            'Yew\Framework\Db\PdoValue' => 'Yew\Framework\Db\PdoValueBuilder',
            'Yew\Framework\Db\Expression' => 'Yew\Framework\Db\ExpressionBuilder',
            'Yew\Framework\Db\Conditions\ConjunctionCondition' => 'Yew\Framework\Db\Conditions\ConjunctionConditionBuilder',
            'Yew\Framework\Db\Conditions\NotCondition' => 'Yew\Framework\Db\Conditions\NotConditionBuilder',
            'Yew\Framework\Db\Conditions\AndCondition' => 'Yew\Framework\Db\Conditions\ConjunctionConditionBuilder',
            'Yew\Framework\Db\Conditions\OrCondition' => 'Yew\Framework\Db\Conditions\ConjunctionConditionBuilder',
            'Yew\Framework\Db\Conditions\BetweenCondition' => 'Yew\Framework\Db\Conditions\BetweenConditionBuilder',
            'Yew\Framework\Db\Conditions\InCondition' => 'Yew\Framework\Db\Conditions\InConditionBuilder',
            'Yew\Framework\Db\Conditions\LikeCondition' => 'Yew\Framework\Db\Conditions\LikeConditionBuilder',
            'Yew\Framework\Db\Conditions\ExistsCondition' => 'Yew\Framework\Db\Conditions\ExistsConditionBuilder',
            'Yew\Framework\Db\Conditions\SimpleCondition' => 'Yew\Framework\Db\Conditions\SimpleConditionBuilder',
            'Yew\Framework\Db\Conditions\HashCondition' => 'Yew\Framework\Db\Conditions\HashConditionBuilder',
            'Yew\Framework\Db\Conditions\BetweenColumnsCondition' => 'Yew\Framework\Db\Conditions\BetweenColumnsConditionBuilder',
        ];
    }
...
//                $value = isset($columnSchemas[$name]) ? $columnSchemas[$name]->dbTypecast($value) : $value;
     ...
     * @param null $value the value for the primary key of the next new row inserted. If this is not set,
     ...
     * @param array|null $params the binding parameters to be populated
     ...
     * @throws \Throwable
     */
    public function buildFrom(?array $tables = null, ?array &$params = null): string
    {
        if (empty($tables)) {
            return '';
        }
     ...
     * to instance of [[Yew\Framework\Db\condition\ConditionInterface|ConditionInterface]] according to
    ...
    public function createConditionFromArray($condition)
    {
        if (isset($condition[0])) { // operator format: operator, operand 1, operand 2, ...
            ...
            $className = $this->conditionClasses[$operator] ?? 'Yew\Framework\Db\Conditions\SimpleCondition';
     ...
     * @since 2.0.14
     */
    public function bindParam(?string $value = null, array &$params = []): string
    {
