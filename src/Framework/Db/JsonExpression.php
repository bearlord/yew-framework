...
class JsonExpression implements ExpressionInterface, \JsonSerializable
{
     ...
     * The value must be compatible with [\Yew\Framework\Helpers\Json::encode()|Json::encode()]] input requirements.
     */
    protected $value;
    /**
     ...
     * The value must be compatible with [\Yew\Framework\Helpers\Json::encode()|Json::encode()]] requirements.
