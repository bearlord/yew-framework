...
interface ActiveRecordInterface
{
     ...
     *
     * ```php
     * // Yew\Framework\Web\Controller ensures that $id is scalar
     ...
     * ```
     *
     * @param bool $runValidation whether to perform validation (calling [[\Yew\Framework\Base\Model::validate()|validate()]])
