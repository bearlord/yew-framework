 ...
 *
 * By default, [[\Yew::$container]] refers to a Container instance which is used by [[\Yew::createObject()]]
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\Yew\Framework\Base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * or [[setSingleton()]].
     * @param array|null $params a list of constructor parameter values. The parameters should be provided in the order
     ...
     * $container->set('Yew\Framework\Mail\MailInterface', 'yew\swiftmailer\Mailer');
     *
     ...
     * @param array|null $params the list of constructor parameters. The parameters will be passed to the class
    ...
    protected function build(string $class, array $params, array $config): object
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('Yew\Framework\Base\Configurable')) {
    ...
    public function resolveCallableDependencies(callable $callback, array $params = []): array
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if ($isClass) {
                ...
                } elseif (isset(Yew::$app) && Yew::$app->has($name) && ($obj = Yew::$app->get($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
