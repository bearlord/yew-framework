...
class BaseFileHelper
{
     ...
     * If not set, the value of [[\Yew\Framework\Base\Application::language]] will be used.
     * @param string $sourceLanguage the language that the original file is in.
     * If not set, the value of [[\Yew\Framework\Base\Application::sourceLanguage]] will be used.
     ...
     * @throws \Yew\Framework\Base\Exception if the directory could not be created (i.e. php error due to parallel changes)
     */
