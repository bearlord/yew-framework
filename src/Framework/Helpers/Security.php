...
class Security
{
    ...
    protected function encrypt($data, $passwordBased, $secret, $info)
    {
        ...
        if ($encrypted === false) {
            throw new \Yew\Framework\Base\Exception('OpenSSL failure on encryption: ' . openssl_error_string());
        }
    ...
    protected function decrypt($data, $passwordBased, $secret, $info)
    {
        ...
        if ($decrypted === false) {
            throw new \Yew\Framework\Base\Exception('OpenSSL failure on decryption: ' . openssl_error_string());
        }
