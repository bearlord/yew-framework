...
class BaseHtml
{
     ...
     * The [[\Yew\Framework\Base\Application::charset|application charset]] will be used for encoding.
    ...
    {
        return htmlspecialchars($content, ENT_QUOTES | ENT_SUBSTITUTE, Yew::$app ? Yew::$app->charset : 'UTF-8', $doubleEncode);
    }
     ...
     * See [[Yew\Framework\Web\Request::methodParam]] for more details.
     * @param array $options the tag options in terms of name-value pairs. These will be rendered as
     * the attributes of the resulting tag. The values will be HTML-encoded using [[encode()]].
     * If a value is null, the corresponding attribute will not be rendered.
     * See [[renderTagAttributes()]] for details on how attributes are being rendered.
     ...
     * @see Yew\Framework\Helpers\Url::to()
     */
     ...
     * the `maxlength` option will take the value of [[Yew\Framework\Validators\StringValidator::max]].
     * @param Model $model the model object
